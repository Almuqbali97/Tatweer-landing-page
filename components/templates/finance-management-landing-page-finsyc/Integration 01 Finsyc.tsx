...
const leftIntegrations: IntegrationItem[] = [
  {
    ...
    description: "Lead programmes and controls",
    icon: "https://cdn.jiro.build/Amox/All%20Images/Plaid-icon-01.png",
  },
  {
    id: "masterplanning",
    name: "Masterplanning",
    description: "Plan integrated city systems",
  ...
  },
  {
    id: "engineering",
    name: "Engineering",
    description: "Coordinate every discipline",
          ...
          <div className="w-full max-w-[1248px] mx-auto">
            ...
            <div className="flex flex-col items-center text-center mb-12 md:mb-[80px]">
              ...
              >
                ...
                <span className="text-[#138E5F] text-[14px] font-medium font-sans">Collaboration Ecosystem</span>
              </motion.div>
              ...
              >
                One network aligned around{" "}
                <span className="italic text-[rgba(0,0,0,0.40)]">project success</span>
              </motion.h2>
              ...
              >
                Tatweer combines specialist companies, disciplines, and delivery partners into one coordinated platform for development.
              </motion.p>
            </div>
            ...
            <div className="flex flex-col items-center mt-12 md:mt-[80px] gap-6 md:gap-8">
              ...
              >
                ...
                <p className="text-[13px] md:text-[15px] font-sans">
                  <span className="text-[#138E5F] font-semibold">Partnership-led delivery.</span>{" "}
                  <span className="text-[#042718]/40">Shared expertise, resources, and accountability.</span>
                </p>
              </motion.div>
              ...
              >
                Connecting{" "}
                <span className="font-semibold text-[#138E5F]">development</span>,{" "}
                <span className="font-semibold text-[#138E5F]">engineering</span>, and{" "}
                <span className="font-semibold text-[#138E5F]">investment</span>{" "}
                capabilities around a common project vision.
              </motion.p>
            </div>
