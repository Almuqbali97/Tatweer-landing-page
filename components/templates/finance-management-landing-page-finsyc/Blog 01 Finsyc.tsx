          ...
          <div className="w-full max-w-[1248px] mx-auto">
            ...
            <div className="flex flex-col items-center text-center mb-12 md:mb-[80px]">
              ...
              >
                ...
                <span className="text-[#138E5F] text-[13px] font-sans font-medium uppercase tracking-wider">Selected Projects</span>
              </motion.div>
              ...
              >
                A portfolio spanning <span className="italic text-[rgba(4,39,24,0.40)]">cities</span>, infrastructure and energy
              </motion.h2>
              ...
              >
                Representative projects and opportunities reflecting Tatweer’s development, project management, and investment capability.
              </motion.p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6 justify-center">
              <BlogCard
                ...
                description="Development experience at Muscat Hills, including work connected to a landmark commercial building and 10 mansions."
                tags={["Development", "Commercial", "Oman"]}
                imageTop={true}
                delay={0.3}
              />
              <BlogCard
                ...
                description="A mixed-use island development shaped by the ambition to create responsibly within a UNESCO-protected setting."
                tags={["Mixed-use", "Island", "Investment"]}
                imageTop={false}
                delay={0.4}
              />
            </div>
